...
$router->get("/register", 'App\Controllers\Authentication\\RegisterController', 'index', ['authentication/register']); //

$router->get("/authenticate", 'App\Controllers\Authentication\\AuthenticateController', 'index', ['authentication/authenticate']);
...
$router->get("/notes", 'App\Controllers\Notes\\NotesController', 'index', ['notes/index']);
$router->get("/notes/create", 'App\Controllers\Notes\\NotesController', 'index', ['notes/create']); // try
